 ...
 * Estilo baseado no módulo Vendas - dropdown com pesquisa integrada
...
export default function MultiSelect({
  ...
  // Calcular posição real após o dropdown renderizar
  useEffect(() => {
  ...
  return (
    <div style={{ marginBottom: '16px', position: 'relative' }} ref={containerRef}>
      {label && (
