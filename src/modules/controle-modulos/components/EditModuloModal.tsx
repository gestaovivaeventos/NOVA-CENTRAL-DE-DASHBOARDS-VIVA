...
import { X, Save, Settings, Search, Check } from 'lucide-react';
        ...
        <div style={{ padding: '24px' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            >
              ...
              {!GRUPOS.includes(grupo) && grupo && (
                <option value={grupo} style={{ color: '#F8F9FA', backgroundColor: '#1a1d21' }}>
                  {grupo} (personalizado)
                </option>
              )}
            </select>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <input
              ...
              placeholder="ex: bar-chart, settings, users..."
              style={inputStyle}
            />
          </div>
