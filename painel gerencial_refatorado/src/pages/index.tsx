...
export default function Home() {
  ...
  const okrsNaMeta = data.okrs.filter(o => o.atingimento >= 1).length;
  const okrsEmRisco = data.okrs.filter(o => o.atingimento >= 0.61 && o.atingimento < 1).length;
  const timesCom80 = data.teamPerformance.filter(t => t.mediaGeral >= 80).length;
